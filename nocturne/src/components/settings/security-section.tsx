    ...
    <>
      <div>
          ...
          <AnimatePresence>
            {passphraseSaved && (
              <motion.span
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="text-caption text-indigo-400"
              >
                Passphrase updated
              </motion.span>
            )}
        ...
        <Row
          ...
          description="Your passphrase encrypts your Master Key. Nocturne cannot reset it."
        >
          <button
            type="button"
          ...
          <form onSubmit={handleRecoveryDownload} className="flex flex-col gap-4 mt-2">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                className="h-9 px-4 rounded-btn text-body font-medium bg-indigo-500 text-text-inverse hover:bg-indigo-600 transition-colors disabled:opacity-60"
              >
