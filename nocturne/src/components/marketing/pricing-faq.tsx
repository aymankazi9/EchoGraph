...
const faqs = [
  ...
  },
  {
    ...
    a: 'Your files are encrypted in your browser before they ever leave your device. Nocturne servers store only opaque encrypted blobs — we cannot read your lecture audio, slides, or transcripts even if we wanted to. Your vault passphrase never touches our servers.',
  },
  {
    q: 'What is the difference between Red Zone and Likely Zone?',
    a: 'Red Zone (red) is derived from your uploaded Study Guide — it reflects what your professor emphasized relative to what you actually need to know. Likely Zone (purple) is Nocturne\'s synthetic estimate when no study guide is provided. It\'s useful, but it\'s inferred, not professor-verified.',
  },
  {
  ...
  {
    q: 'Does Nocturne send my audio to any AI service?',
