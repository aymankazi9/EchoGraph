          ...
          {plans.map((plan) => (
            ...
            >
              ...
              {plan.coming ? (
                ...
                <Link
                  href={plan.href}
                  className="w-full h-9 rounded-btn text-body font-medium bg-indigo-500 text-text-inverse hover:bg-indigo-600 transition-colors inline-flex items-center justify-center mb-5"
                >
                  {plan.cta}
                </Link>
              )}
