...
const steps = [
  {
    ...
    body: 'Nocturne extracts text from every slide and generates a Synthetic Study Guide automatically. Likely Zone keywords appear immediately — no study guide required.',
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Icon
                    size={16}
                    strokeWidth={1.5}
                    className={step.highlight ? 'text-indigo-400' : 'text-text-tertiary'}
                  />
                </div>
