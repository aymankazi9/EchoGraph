...
const sections: Section[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No. Nocturne works with whatever you have. Slides only gives you the PDF viewer and Synthetic Study Guide. Audio only gives you transcription and Likely Zone scoring. The more inputs you provide, the more features unlock — but you\'re never blocked from starting.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Encrypted file blobs are stored in Supabase Storage. Nocturne servers see only opaque encrypted data — they cannot decrypt it. Your passphrase and Master Key exist only in your browser memory while your vault is open.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Likely Zone (shown in purple) is Nocturne\'s synthetic estimate when you haven\'t uploaded a study guide. It uses TF-IDF and professor dwell time to infer what\'s likely important. It upgrades automatically to Red Zone when you add a real study guide.',
      },
      {
        q: 'How does the Anki import work?',
        a: 'Nocturne parses the SQLite database inside an .apkg file and extracts card fronts as your keyword list. This seeds the Study Guide automatically — all Red Zone scoring and heatmaps activate immediately based on your existing Anki deck.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No. Nocturne uses a local write-ahead buffer (IndexedDB) so partial uploads can resume. If your upload fails, reopen the session and the upload panel will show the failed files — you can retry without re-selecting them.',
      },
      {
