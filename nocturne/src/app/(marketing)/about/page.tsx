...
const features = [
  {
    ...
    description:
      'Nocturne scores every lecture moment against your study guide and what your professor actually dwelled on. The result: a ranked list of what matters most, not a summary of everything.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      'Upload your study guide or import an Anki deck. Nocturne uses it to calibrate emphasis scoring — your notes shape the analysis, not a generic model trained on someone else\'s curriculum.',
  },
]
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-body text-text-secondary leading-relaxed">
            Nocturne started with a simple observation: generic AI study tools summarize content.
        ...
        <section className="mb-14 p-6 rounded-card border border-border-default bg-bg-elevated">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-body text-text-secondary leading-relaxed">
              ...
              your professor emphasized. Nocturne connects those two signals — and ranks everything
            ...
            {features.map(({ icon: Icon, title, description }) => (
              <div key={title} className="flex gap-4 p-5 rounded-card border border-border-default bg-bg-elevated">
                <div className="p-2 rounded-btn bg-bg-subtle shrink-0 h-fit">
                  <Icon size={18} strokeWidth={1.5} className="text-indigo-400" />
                </div>
                <div>
        ...
        <section className="mb-14 p-6 rounded-card border border-border-default bg-bg-elevated">
          ...
          <p className="text-body text-text-secondary leading-relaxed mb-3">
            Nocturne is not for the student who wants to paste a YouTube link and get flashcards
