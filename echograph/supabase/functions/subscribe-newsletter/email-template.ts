...
<head>
  ...
  <title>Confirm your EchoGraph subscription</title>
</head>
<body style="margin:0;padding:0;background-color:#0F1117;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="margin-bottom:24px;">
      <span style="font-size:32px;color:#1D9E75;font-weight:500;line-height:1;">E</span>
      <span style="font-size:18px;color:#E8EDF5;font-weight:500;margin-left:8px;">EchoGraph</span>
    </div>
    ...
    <p style="font-size:14px;color:#8B97AD;line-height:1.6;margin:0 0 24px;padding:0;">
      Click the button below to confirm your subscription to EchoGraph updates.
    ...
    <p style="font-size:12px;color:#5A6880;text-align:center;margin:0 0 4px;padding:0;">
      EchoGraph &middot; Privacy-first study intelligence
    </p>
    <p style="font-size:12px;color:#5A6880;text-align:center;margin:0;padding:0;">
      You&#39;re receiving this because you signed up at echograph.app
    </p>
