  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-3">
        <KeyRound size={32} strokeWidth={1.25} className="text-teal-300" />
        <div className="flex flex-col gap-1.5">
          <h1 className="text-display font-medium text-text-primary">Recover vault access</h1>
          <p className="text-body text-text-secondary">
            Paste the contents of your <span className="font-mono text-body">echograph-recovery-kit.txt</span> file
            below.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className={[
              ...
              'focus:outline-none focus:border-teal-300 focus:shadow-teal',
