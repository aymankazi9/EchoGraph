...
function Cell({ value }: { value: FeatureValue }) {
  ...
  return value
    ? <Check size={14} strokeWidth={2} className="text-teal-300 mx-auto" />
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              {plan.coming ? (
                ...
                <Link
                  href={plan.href}
                  className="w-full h-9 rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors inline-flex items-center justify-center"
                >
                  {plan.cta}
                </Link>
              )}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-border-default">
                  ...
                  <th className="px-4 py-3 text-body-sm font-medium text-text-primary text-center bg-teal-500/5">
                    Scholar
                  </th>
                  <th className="px-4 py-3 text-body-sm font-medium text-text-primary text-center">
                    Pro
              ...
              <tbody>
                {features.map((feat, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-center bg-teal-500/5">
