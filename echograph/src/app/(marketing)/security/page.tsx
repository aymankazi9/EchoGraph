...
export const metadata: Metadata = {
  title: 'Security — EchoGraph',
  description: 'How EchoGraph protects your data with zero-knowledge encryption. Your files are unreadable to us by design.',
}
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-body text-text-secondary max-w-xl">
            EchoGraph servers store your data but cannot read it. Encryption happens in your browser,
              ...
              <ul className="flex flex-col gap-3">
                {weCan.map((item) => (
                  <li key={item} className="flex items-start gap-2.5">
                    <Check size={14} strokeWidth={2} className="text-teal-300 mt-0.5 shrink-0" />
        ...
        <section id="disclosure" className="pt-8 border-t border-border-subtle">
          ...
          <a
            href="mailto:security@echograph.app"
