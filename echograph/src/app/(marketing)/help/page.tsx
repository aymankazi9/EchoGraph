...
export const metadata: Metadata = {
  title: 'Help — EchoGraph',
  description: 'Answers to common questions about EchoGraph — getting started, encryption, features, and troubleshooting.',
}
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p className="text-body text-text-secondary">
            ...
            <a href="mailto:hello@echograph.app" className="text-teal-300 hover:underline">
              hello@echograph.app
            </a>
          </p>
        </div>
