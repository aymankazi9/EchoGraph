    ...
    <div className="flex items-center justify-center gap-2 h-10 border-t border-border-default shrink-0 bg-bg-elevated px-4">
      ...
      <div className="flex items-center gap-1.5 text-label text-text-secondary">
        <input
          ...
          className="w-12 h-7 text-center text-label text-text-primary bg-bg-input border border-border-default rounded-input focus:border-teal-300 focus:outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
