  ...
  ({ label, error, id, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <input
            ...
            className={[
              ...
              'focus:outline-none focus:border-teal-300 focus:ring-1 focus:ring-teal-300/40',
              error
                ? 'border-red-200 ring-1 ring-red-200/40'
        ...
        {error && <p className="text-label text-red-200">{error}</p>}
      </div>
    )
  },
)
