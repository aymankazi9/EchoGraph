...
// DESIGN_SYSTEM.md §6: play/pause = 40×40 teal-300 circle.
  ...
  if (loadError) {
    return (
      <div className="flex items-center justify-center h-full p-4">
        <p className="text-label text-red-200 text-center">{loadError}</p>
      </div>
    )
  }
    ...
    <div className="flex flex-col h-full p-4 gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-10 h-10 rounded-full bg-teal-300 text-text-inverse flex items-center justify-center hover:bg-teal-400 transition-colors disabled:opacity-40 shrink-0"
        >
          {isDecrypting ? (
