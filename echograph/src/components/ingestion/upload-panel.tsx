  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-5 flex flex-col gap-5">
        ...
        {error && (
          <p className="text-body-sm text-red-200">{error}</p>
        )}
      </div>
      ...
      {progress.length === 0 && (
        <div className="px-5 py-4 border-t border-border-default shrink-0">
          <button
            ...
            className="w-full h-9 rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
          >
