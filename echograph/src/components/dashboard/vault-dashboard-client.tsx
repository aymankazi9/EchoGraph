  ...
  return (
    <div className="px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <Link
          href="/session/new"
          className="inline-flex items-center gap-1.5 h-9 px-4 rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors"
        >
