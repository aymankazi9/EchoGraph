      ...
      <AnimatePresence>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <AlertTriangle size={32} strokeWidth={1.25} className="text-red-200" />
            <div className="flex flex-col gap-1.5">
              <h2 className="text-subheading font-medium text-text-primary">
                We cannot recover your account
              </h2>
              <p className="text-body text-text-secondary">
                EchoGraph uses zero-knowledge encryption. Your vault passphrase never leaves your
          ...
          <button
            ...
            className="w-full h-9 px-4 rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors flex items-center justify-center gap-2"
          >
          ...
          <div className="flex flex-col gap-3">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="mt-0.5 accent-teal-300 w-4 h-4 shrink-0 cursor-pointer"
              />
              <span className="text-body-sm text-text-secondary">
                I understand that losing my vault passphrase and Recovery Kit means my data cannot
                be recovered by anyone, including EchoGraph.
              </span>
            </label>
            ...
            >
              <input
                ...
                className="mt-0.5 accent-teal-300 w-4 h-4 shrink-0"
              />
              <span className="text-body-sm text-text-secondary">
          ...
          <button
            ...
            className={[
              ...
              canOpen
                ? 'bg-teal-300 text-text-inverse hover:bg-teal-400 cursor-pointer'
                : 'bg-teal-300 text-text-inverse cursor-not-allowed opacity-30',
            ].join(' ')}
          >
            Open vault
          </button>
