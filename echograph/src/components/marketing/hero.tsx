  ...
  return (
    <section className="flex flex-col items-center text-center px-6 pt-24 pb-20 md:pt-32 md:pb-28">
      ...
      <motion.p
        ...
        initial="hidden"
        animate="visible"
        className="text-caption uppercase tracking-[0.07em] text-teal-300 mb-5"
      >
      ...
      >
        EchoGraph links your lecture audio, slides, and study guide — then tells you
      ...
      >
        <Link
          href="/login"
          className="inline-flex h-10 px-6 items-center rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors"
        >
          Start for free
        </Link>
        <button
