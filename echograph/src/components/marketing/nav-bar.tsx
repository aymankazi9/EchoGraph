    ...
    <>
      ...
      >
          ...
          {navLinks.map(({ label, href, soon }) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <span className="absolute bottom-1 left-3.5 right-3.5 h-px bg-teal-300 rounded-full" />
                )}
              </Link>
            )
          })}
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/login"
            className="hidden sm:inline-flex h-9 px-4 items-center rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors"
          >
            Get started
          </Link>
