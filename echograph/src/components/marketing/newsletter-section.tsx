          ...
          {showSuccess ? (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                {status === 'pending' ? (
                  <CheckCircle size={20} strokeWidth={1.5} className="text-teal-300 shrink-0" />
                ) : (
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="flex gap-2 max-w-[440px] mx-auto">
                  ...
                  <button
                    type="submit"
                    disabled={status === 'loading'}
                    className="h-10 px-5 rounded-btn bg-teal-300 text-text-inverse text-body-sm font-medium hover:bg-teal-400 transition-colors disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 shrink-0"
                  >
                    {status === 'loading' ? (
                      <>
                ...
                <AnimatePresence>
                  {emailError && (
                    <motion.p
                      ...
                      className="text-caption text-red-200 mt-1.5 text-left max-w-[440px] mx-auto"
                    >
                      {emailError}
                    </motion.p>
                  )}
                ...
                <div className="flex items-start gap-2 max-w-[440px] mx-auto mt-2.5 text-left">
                  ...
                  >
                    I agree to receive product updates from EchoGraph. You can unsubscribe at any
                    time. We never share your email. View our{' '}
                    <Link href="/privacy" className="text-teal-300 underline hover:text-teal-200">
                      Privacy Policy
                    </Link>
                    .
                  </label>
                ...
                <AnimatePresence>
                  {status === 'error' && (
                    ...
                    >
                      <AlertTriangle size={14} strokeWidth={1.5} className="text-red-200 shrink-0" />
