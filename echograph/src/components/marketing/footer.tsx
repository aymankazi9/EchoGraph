      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="pt-6 border-t border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-btn bg-teal-300 flex items-center justify-center text-text-inverse text-[13px] font-semibold select-none shrink-0">
              E
            </div>
            <div>
              <p className="text-caption text-text-tertiary">
                © {new Date().getFullYear()} EchoGraph
              </p>
              <p className="text-caption text-text-tertiary">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://github.com/echograph"
              target="_blank"
            ...
            <a
              href="https://twitter.com/echograph"
              target="_blank"
              rel="noopener noreferrer"
              className="text-caption text-text-tertiary hover:text-text-secondary transition-colors"
            >
