    ...
    >
      <span
        className={[
          ...
          active ? 'bg-teal-300' : 'bg-text-tertiary',
        ].join(' ')}
      />
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full gap-6 px-8 text-center select-none overflow-hidden">
      ...
      <div className="relative flex flex-col items-center gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-body-sm text-text-secondary">
            Upload your lecture files to unlock EchoGraph
          </p>
        </div>
      </div>
      ...
      <button
        ...
        className="relative inline-flex items-center gap-1.5 h-9 px-4 rounded-btn text-body font-medium bg-teal-300 text-text-inverse hover:bg-teal-400 transition-colors"
      >
