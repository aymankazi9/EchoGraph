        ...
        >
          ...
          <div className="flex items-center justify-between px-3 py-2 border-b border-border-default shrink-0">
            <div className="flex items-center gap-1.5">
              {isRed ? (
                <Zap size={14} strokeWidth={1.5} className="text-red-200" />
              ) : (
                <Layers size={14} strokeWidth={1.5} className="text-purple-300" />
              )}
              <span
                className={[
                  'text-label font-medium truncate',
                  isRed ? 'text-red-200' : 'text-purple-300',
                ].join(' ')}
              >
                {keyword.term}
              </span>
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <Bar
                  ...
                  max={maxMentions}
                  color={isRed ? 'bg-red-200' : 'bg-purple-300'}
                />
              </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {keyword.slideIndices.map((idx) => (
                    <button
                      ...
                      className="text-caption px-2 py-0.5 rounded-btn border border-border-default text-text-secondary hover:bg-bg-subtle hover:text-teal-300 transition-colors"
                    >
                      Slide {idx}
                    </button>
                  ))}
